"""Evaluate ReMSTNet on the established six-condition SyncG roster."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    result = evaluate_remstnet_syncg(
...
__all__ = ["PROTOCOL", "evaluate_remstnet_syncg"]

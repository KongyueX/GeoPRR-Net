"""Train one hierarchical ReMSTNet pilot on the existing physical triplets."""
...
def load_remst_block_checkpoint(
...
def train_remst_block_pilot(
    *,
    ...
    architecture_variant: str = "hierarchical_v1",
) -> dict[str, Any]:
    """Train the two ReMST blocks while retaining the imported foundation."""
    ...
    checkpoint = {
        ...
        "parameter_counts": remst_block_parameter_counts(model),
        "history": history,
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    result = train_remst_block_pilot(
...
__all__ = [
    ...
    "PROTOCOL",
    "load_remst_block_checkpoint",
    "train_remst_block_pilot",
]
